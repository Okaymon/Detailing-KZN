# MS Detailing — Сайт детейлинг-студии

## Описание проекта
Одностраничный премиум-сайт для детейлинг-студии **MS Detailing**. Светлый элегантный дизайн с золотыми акцентами, кинематографичной анимацией на главном экране (G-Wagon изумрудного цвета) и эффектами блеска/искр.
